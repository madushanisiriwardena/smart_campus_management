...
<div class="container">
    ...
    <main id="content-area">
        ...
        <table class="table">
            ...
            <tr>
                <th scope="col">#</th>
                <th scope="col" width="300">Code</th>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Booking Panel</h1>
            ...
            <div class="modal-body">
                <form id="bookingForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control datetimepicker" id="startDate" placeholder="Select start date & time" required>
                    </div>

                    <!-- Step 3: End Date & Time -->
                    <div class="mb-3">
                        <label for="endDate" class="form-label">End Date & Time</label>
                        <input type="text" class="form-control datetimepicker" id="endDate" placeholder="Select end date & time" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" id="bookButton" onclick="book(2)">Book</button>
            </div>
        </div>
    </div>
</div>
